---
title: "Object Tags"
api: "POST /organizations/{org_id}/objects/tags"
...
```
GET /organizations/{org_id}/objects/{object_id}
```
...
```bash
curl "https://back.flowieapp.com/organizations/org_abc123/objects/inv_001?object_type=invoice" \
...
```
POST /organizations/{org_id}/objects/tags
```
...
```bash
curl -X POST https://back.flowieapp.com/organizations/org_abc123/objects/tags \
  -H "Authorization: Bearer YOUR_TOKEN" \
...
```
POST /organizations/{org_id}/objects/tags/bulk
```
...
```
POST /organizations/{org_id}/objects/tags/auto
```
...
```
POST /organizations/{org_id}/objects/tags/duplicate
```
...
```
DELETE /organizations/{org_id}/objects/{object_id}/tags/{tag_id}
```

## Get Tags by Context

```
GET /organizations/{org_id}/contexts/{context_id}
```
...
- `GET /contexts/{id}/csv` - Export as CSV
- `GET /contexts/{id}/json` - Export as JSON
